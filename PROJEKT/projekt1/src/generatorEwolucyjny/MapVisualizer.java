...
/* Drobna modyfikacja programu udostępnionego przez wykładowcę */

import agh.cs.lab5.Vector2d;

/**
 * The map visualizer converts the {@link ProjectMap} map into a string
 * representation.
 *
 * @author apohllo
 */
public class MapVisualizer {
     ...
     * @param map
     */
    public MapVisualizer(ProjectMap map) {
        this.map = map;
    }
